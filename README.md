...
> **Current binary:** Kilo Code `0.0.0-fix-qdrant-check-compatibility-202607270715` (built from upstream Kilo `v7.4.16` merged into the local `fix/qdrant-check-compatibility` fork).  
